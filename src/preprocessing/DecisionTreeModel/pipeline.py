"""Preprocessing pipeline for DecisionTreeModel."""
import pandas as pd
import numpy as np
...
def pipe(logger):
    ...
    logger.info("=" * 80)
    logger.info("Starting Decision Tree preprocessing pipeline")
    logger.info("=" * 80)
    ...
    logger.info("=" * 80)
    logger.info("Decision Tree preprocessing pipeline completed successfully")
    logger.info("=" * 80)
